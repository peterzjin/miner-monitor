...
rrdtool.graph('hash.png', '--lazy', '--title', 'The Hash Power',
        ...
        'DEF:hash3=../miner_state.rrd:m_hash3:AVERAGE',
        'LINE1:hash0#0000ff:Miner#0',
        'LINE1:hash1#0044ff:Miner#1',
        'LINE1:hash2#0088ff:Miner#2',
        'LINE1:hash3#00ccff:Miner#3')
rrdtool.graph('m_temp.png', '--lazy', '--title', 'The Miner Temperature',
        ...
        'DEF:m_temp3=../miner_state.rrd:m_temp3:AVERAGE',
        'LINE1:m_temp0#0000ff:Miner#0',
        'LINE1:m_temp1#0044ff:Miner#1',
        'LINE1:m_temp2#0088ff:Miner#2',
        'LINE1:m_temp3#00ccff:Miner#3')
